...
Sub ProcessString(PacketID As Long, St As String)
        ...
        If Len(St) >= 1 Then
            ...
            Case 3    'Banned
                If Len(St) >= 5 Then
                    ...
                    If Len(St) > 5 Then
                        MsgBox "You are banned from The Odyssey Realms Registry until " + CStr(CDate(A)) + " (" + Mid$(St, 6) + ")!", vbOKOnly, TitleString
                    Else
                        MsgBox "You are banned from The Odyssey Realms Registry until " + CStr(CDate(A)) + "!", vbOKOnly, TitleString
                    End If
                    CloseClientSocket 3
                End If
            Case 4    'Server Full
    ...
    Case 12    'You joined map
        If Len(St) = 13 Then
            ...
            If CMap = 0 Then
                ...
                If B > 0 Then
                    St1 = Mid$(St1, 2)
                    PrintChat "Welcome to the Odyssey Realms Registry!  There are " + CStr(B) + " other players online:" + St1, 15
                Else
                    PrintChat "Welcome to the Odyssey Realms Registry!  There are no other users currently online.", 15
                End If
                LoadOptions
    ...
    Case 16    'Error messages
        If Len(St) >= 1 Then
            ...
            Case 20    'cannot attack player -- you are not in guild
                Call PrintInfoText("You must be guilded to fight here.", 14)
            ...
            Case 48    'Server is being backed up
                'PrintChat "Autosaving Server to .dat", 7
            End Select
        End If
    ...
    Case 74    'Guild Account Status
        If Len(St) = 8 Then
            ...
            PrintChat "Your guild owes " + CStr(A) + " gold.  This must be paid before " + CStr(CDate(B)) + " or your guild will be disbanded.  Type '/guild pay <amount>' to pay toward the debt.", 15
