...
Sub UseSkill(ListIndex As Integer)
    If Not Tick > Character.LastMove + 60000 And Character.IsDead = False Then
        If LastSkillUse + 500 < Tick Then
            LastSkillUse = Tick
            Dim CanUse As Boolean, CheckVar As Byte
            ...
            Case 1    'Fishing
                ...
                If CanUse = True Then
                    ...
                    Else
                        ...
                        Call PrintInfoText("You are too tired to fish!", 14)
                    End If
                Else
                    'PrintChat "You cannot fish here!", 14
                    Call PrintInfoText("You cannot fish here!", 14)
                End If
            Case 2    'Mining
                CanUse = False
                Select Case CDir
                ...
                If CanUse = True Then
                    ...
                    Else
                        ...
                        Call PrintInfoText("You are too tired to mine!", 14)
                    End If
                Else
                    'PrintChat "You cannot mine here!", 14
                    Call PrintInfoText("You cannot mine here!", 14)
                End If
            Case 3    'Lumberjacking
                CanUse = False
                Select Case CDir
                ...
                If CanUse = True Then
                    ...
                    Else
                        ...
                        Call PrintInfoText("You are too tired to chop!", 14)
                    End If
                Else
                    'PrintChat "You cannot chop here!", 14
                    Call PrintInfoText("You cannot chop here!", 14)
                End If
            Case Else
        ...
        Else
            ...
            Call PrintInfoText("You are too tired!", 14)
        End If
    End If
End Sub
