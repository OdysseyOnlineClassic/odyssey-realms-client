...
Public CXO As Long, CYO As Long, CDir As Byte, CWalkStep As Long, CWalkTimer As Long
Attribute CXO.VB_VarUserMemId = 1073741847
Public CAttack As Long, CAttackTimer As Long, CWalk As Long
...
Public FrameCounter As Long, FrameRate As Long, SecondTimer As Long, FrameTimer As Long
...
Public InfoTextColor(0 To 3) As Long
