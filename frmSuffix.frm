...
Private Sub cmdSave_Click()
    ...
    Next A
    SendSocket Chr$(89) + Chr$(lblNumber) + Chr$(TheType) + Chr$(lblModValue) + Chr$(chkOccursNaturally.value) + txtName
    Me.Hide
End Sub

Private Sub Form_Load()
    frmSuffix_Loaded = True
End Sub

Private Sub Form_Unload(Cancel As Integer)
    frmSuffix_Loaded = False
End Sub
